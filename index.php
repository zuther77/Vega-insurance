  ...
  <section id="nav-bar">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#our_policy">our policy</a>
                    </li>
                    <!-- <li class="nav-item"> -->
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn btn-primary" id="myBtn">Login/Register</button>
                    </li>
                </ul> 
        </div>
        </nav>
...
<section id="services">
    ...
    <div class="row">
        ...
        <div class="col-md-3 services">
            <img src="img\renew.png" class="service-icon" onclick="loginalert()">
            <p> Renew My Policy</p>
        </div>   <div class="col-md-3 services">
            <img src="img\claim-status.png" class="service-icon" onclick="loginalert()">
            <p> Claim Status</p>
        </div>  
        <div class="col-md-3 services">
            <img src="img\fund-statement.png" class="service-icon" onclick="loginalert()">
            <p>Fund Statement</p>
        </div>   <div class="col-md-3 services">
            <img src="img\Certificate.png" class="service-icon" onclick="loginalert()">
            ...
            <div class="card">
               ...
               <div class="card-body">
                    <h4 class="card-title">Life Insurance</h4>
                        ...
                        <a class="btn btn-outline-secondary" onclick="loginalert()">Buy Policy</a>
               </div>
            </div>
        </div>
