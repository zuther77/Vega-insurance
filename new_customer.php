...
$db = mysqli_connect("localhost", "root", "", "vega");
 ...
 // try {
 // print_r($_SESSION);
//  $sql = "SELECT * from customer where cust_id in (SELECT customer_pid from insurance where agent_pid in (SELECT agent_id from agent where agent_id= ".$_SESSION['login_id']."))";
// $result = $db->query($sql);
...
<head>
    ...
    <link rel="stylesheet" type="text/css"href="new_customer.css">
    <meta charset="utf-8">
...
<!------------------Banner------------------>
 <section id="banner">
     ...
     <div class="row">
     <div class="col-md-6">
        <p class="something"> Your Customers...</p>  
...
<!----------------------CONTENT--------------------->
    <div class="limiter">
        <div class="container-table100">
            ...
            <div class="wrap-table100">
                    <p>Here are some new customers</p>
                    <div class="table">
 ...
 $sql = "SELECT * FROM `customer` WHERE agent_assigned in (select agent_id from agent where agent_id = ".$_SESSION['login_id'].")";
      $result = $db->query($sql);
while($row = $result->fetch_assoc()) {
     // if ($id == $row['city'] ){               
    echo "              
